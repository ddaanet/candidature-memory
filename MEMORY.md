...
- [project.md](project.md) — Repo, contraintes de modèle, historique (v0.5.0 released, plugin Claude Code)
...
Version courante : 0.5.0 (plugin Claude Code `skills/candidature/` + `.skill` Claude.ai, source unique `src/`)
